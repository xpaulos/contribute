...
def squares():
    ...
    colors = [
        "#FF5733", "#33FF57", "#000000", "#F1C40F", "#AAFF00",
        "#E67E22", "#2ECC71", "#000000", "#E74C3C", "#95A5A6",
        "#9B59B6", "#34495E", "#000000", "#E67E22", "#27AE60",
        "#95A5A6", "#D35400", "#000000", "#7F8C8D", "#F39C12",
        "#2C3E50", "#BDC3C7", "#000000", "#5C6BC0", "#42A5F5",
        "#26A69A", "#66BB6A", "#000000", "#FF7043", "#8D6E63"
    ]
